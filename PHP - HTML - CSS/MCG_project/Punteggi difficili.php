...
<html>
<head>
    <title>Visualizza Punteggi Difficili</title>
...
<body>
    ...
    // Query SQL per selezionare i dati dalla tabella userinfodb con difficoltà 'DIFFICILE'
    $query_sql = "SELECT * FROM userinfodb WHERE Difficoltà LIKE 'DIFFICILE' ORDER BY Punteggio DESC";
    ...
    echo "<h3>Elenco dei massimi punteggi ottenuti nella modalità DIFFICILE : </h3>";
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        ...
                        text: 'Distribuzione Punteggi nella modalità DIFFICILE' // Testo del titolo del grafico
                    }
                }
            },
        });
